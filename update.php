...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    if(empty($input_salary)){
        $salary_err = "Por favor, insira um salário.";     
    } elseif(!ctype_digit($input_salary)){
        $salary_err = "Por favor, insira um valor inteiro positivo.";
    } else{
        $salary = $input_salary;
    }
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p>Por favor, altere os valores desejados e envie para atualizar o funcionário no banco de dados.</p>
